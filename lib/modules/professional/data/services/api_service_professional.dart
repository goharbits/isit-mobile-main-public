...
class ApiServiceProfessional {
  static const baseUrl = ApiBaseUrl.baseUrl;

  static Future<AppUpdateProfileModel?> updateProfile(
      String endpoint, String name, String email, String ssNo, String about, [File? profile, File? certificate]) async {
    try {
      ...
      if (certificate != null) {
        request.files.add(await http.MultipartFile.fromPath(
          'certificate', // Parameter name expected by the API
          certificate.path,
        ));
      }
