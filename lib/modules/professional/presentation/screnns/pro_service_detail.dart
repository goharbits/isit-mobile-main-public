...
class ProServiceDetail extends StatefulWidget {
  String serviceName;

  ProServiceDetail({super.key, required this.serviceName});

  @override
  State<ProServiceDetail> createState() => _ProServiceDetailState();
}

class _ProServiceDetailState extends State<ProServiceDetail> {
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Get.to(()=> EditService(serviceName: "Plumber", servicePrice: '', currency: '', serviceId: 1,));
                    },
                    child: Container(
                      height: 40,
                      width: 40,
