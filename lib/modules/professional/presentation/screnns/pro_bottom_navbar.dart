...
import 'package:isit_app/modules/professional/presentation/screnns/myProfile/pro_my_profile.dart';
import 'package:isit_app/modules/professional/presentation/screnns/pro_dashboard_screen.dart';
import 'package:persistent_bottom_nav_bar/persistent_bottom_nav_bar.dart';

import '../../../../common/screens/requests/requests_screen.dart';
import '../../../../constants/app_colors.dart';

class ProBottomNavbar extends StatefulWidget {
  const ProBottomNavbar({super.key});

  @override
  State<ProBottomNavbar> createState() => _ProBottomNavbarState();
}

class _ProBottomNavbarState extends State<ProBottomNavbar> {
  ...
  List<Widget> _buildScreens() {
    return [
      Navigator(
        onGenerateRoute: (settings) {
          return MaterialPageRoute(
            builder: (context) => ProDashboardScreen(), // Replace with your screen
          );
        },
      ),
      Navigator(
      ...
      Navigator(
        onGenerateRoute: (settings) {
          return MaterialPageRoute(
            builder: (context) => ProMyProfile(), // Replace with your screen
          );
        },
      ),
    ];
