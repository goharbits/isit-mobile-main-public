...
import 'package:isit_app/modules/corporate/presentation/screens/company_dashboard_screen.dart';
...
class CompanyBottomNavbar extends StatefulWidget {
  ...
  @override
  State<CompanyBottomNavbar> createState() => _CompanyBottomNavbarState();
}
  ...
  List<Widget> _buildScreens() {
    return [
      Navigator(
        onGenerateRoute: (settings) {
          return MaterialPageRoute(
            builder: (context) => CompanyDashboardScreen(), // Replace with your screen
          );
        },
      ),
      Navigator(
      ...
      Navigator(
        onGenerateRoute: (settings) {
          return MaterialPageRoute(
            builder: (context) => CompanyMyProfile(), // Replace with your screen
          );
        },
      ),
    ];
