...
import 'package:isit_app/modules/employee/data/controller/emp_drawer_controller.dart';
import 'package:isit_app/modules/employee/presentation/widgets/emp_drawer_screen.dart';
...
import '../components/emp_dashboard_card.dart';

class EmpDashboardScreen extends StatefulWidget {
  EmpDashboardScreen({super.key});
...
class _EmpDashboardScreenState extends State<EmpDashboardScreen> {
  ...
  final EmpDrawerController drawerController = Get.put(EmpDrawerController());
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          //         profileRoute: Get.to(() => EmpMyProfile())));
          //   },
          //   index2: () {
